  ...
  "modules": [
    ...
    },
    {
      ...
      "content": [
        ...
        {
          "title": "RAG：企业级 AI 方案",
          "description": "RAG（检索增强生成）是目前解决企业级数据幻觉问题的主流商用方案。普通 PM 只知道「把 PDF 传上去」，但你需要理解更深：",
          "source": "https://gemini.google.com/",
          "memoryCard": {
            "title": "RAG 三大核心",
            "rows": [
              ["分段策略", "按表格分段 vs 按语义分段"],
              ["数据清洗", "PDF 表格 → Markdown/JSON"],
              ["多维索引", "向量搜索 vs 关键词+元数据过滤"]
            ]
          },
          "tips": [
            "金融研报：表格数据多，按表格分段效果更好",
            "技术文档：语义连贯，按段落分段更合适",
            "向量搜索：适合语义相似，但不适合精确匹配",
            "关键词+元数据：适合精确筛选，如「2024年Q3财报」"
          ]
        },
        {
          "title": "RAG 选型决策",
          "description": "PM 需要知道什么时候用 RAG，以及如何选型：",
          "memoryCard": {
            "title": "RAG vs 其他方案",
            "rows": [
              ["RAG", "企业知识库、文档问答", "数据实时更新"],
              ["Fine-tuning", "特定风格、领域专家", "训练成本高"],
              ["Prompt", "简单场景、快速验证", "上下文有限"],
              ["Agent", "复杂任务、多步骤", "成本高、延迟大"]
            ]
          }
        }
      ],
      "quiz": [
        ...
        {
          "text": "RAG 主要解决什么问题？",
          "options": ["让 AI 更聪明", "企业级数据幻觉问题", "降低 AI 成本", "提高 AI 速度"],
          "correct": 1,
          "explanation": "RAG（检索增强生成）是目前解决企业级数据幻觉问题的主流商用方案。"
        },
        {
          "text": "金融研报的分段策略应该？",
          "options": ["按语义分段", "按表格分段", "不分段", "随机分段"],
          "correct": 1,
          "explanation": "金融研报表格数据多，按表格分段效果更好，能保留数据完整性。"
        },
        {
          "text": "向量搜索的局限性是？",
          "options": ["太慢", "不适合精确匹配", "太贵", "不支持中文"],
          "correct": 1,
          "explanation": "向量搜索适合语义相似，但不适合精确匹配，如「2024年Q3财报」需要关键词+元数据过滤。"
        }
      ]
    },
    {
